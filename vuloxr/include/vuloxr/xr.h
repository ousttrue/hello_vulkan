...
struct Instance : NonCopyable {
  ...
  createVulkan(PFN_vkDebugUtilsMessengerCallbackEXT pfnUserCallback = nullptr) {
    ...
    CheckXrResult(GetVulkanGraphicsRequirements2KHR(
        this->instance, this->systemId, &graphicsRequirements));
    ...
    VkResult err;
    CheckXrResult(CreateVulkanInstanceKHR(this->instance, &createInfo,
                                          &vkInstance, &err));
    ...
    CheckXrResult(GetVulkanGraphicsDevice2KHR(this->instance, &deviceGetInfo,
                                              &vkPhysicalDevice));
    ...
    VkDeviceCreateInfo deviceInfo{
        ...
        .ppEnabledLayerNames = instance.layers.data(),
        .enabledExtensionCount =
            static_cast<uint32_t>(device.extensions.size()),
    ...
    VkDevice vkDevice;
    CheckXrResult(CreateVulkanDeviceKHR(this->instance, &deviceCreateInfo,
                                        &vkDevice, &err));
