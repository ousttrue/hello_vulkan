...
int
egl_show_current_context_attrib (FILE *fp)
{
    EGLDisplay dpy;
    EGLContext ctx;
    EGLint ival;
    ...
    fprintf (fp, " %-32s: ", "EGL_CONFIG_ID"); ival = -1;
    eglQueryContext (dpy, ctx, EGL_CONFIG_ID, &ival);
    fprintf (fp, "%d\n", ival);

    fprintf (fp, " %-32s: ", "EGL_CONTEXT_CLIENT_TYPE"); ival = -1;
    eglQueryContext (dpy, ctx, EGL_CONTEXT_CLIENT_TYPE, &ival);
    switch (ival)
    {
    case EGL_OPENGL_API   : fprintf (fp, "EGL_OPENGL_API\n");    break;
    case EGL_OPENGL_ES_API: fprintf (fp, "EGL_OPENGL_ES_API\n"); break;
    case EGL_OPENVG_API   : fprintf (fp, "EGL_OPENVG_API\n");    break;
    default:                fprintf (fp, "UNKNOWN\n");           break;
    }
  
    fprintf (fp, " %-32s: ", "EGL_CONTEXT_CLIENT_VERSION"); ival = -1;
    eglQueryContext (dpy, ctx, EGL_CONTEXT_CLIENT_VERSION, &ival);
    fprintf (fp, "%d\n", ival);

    fprintf (fp, " %-32s: ", "EGL_RENDER_BUFFER"); ival = -1;
    eglQueryContext (dpy, ctx, EGL_RENDER_BUFFER, &ival);
    switch (ival)
    {
    case EGL_SINGLE_BUFFER: fprintf (fp, "EGL_SINGLE_BUFFER\n"); break;
    case EGL_BACK_BUFFER  : fprintf (fp, "EGL_BACK_BUFFER\n");   break;
    default:                fprintf (fp, "UNKNOWN\n");           break;
    }
    fprintf (fp, "-------------------------------------------------\n");
    return 0;
...
int
egl_show_current_config_attrib (FILE *fp)
{
    EGLDisplay dpy;
    EGLContext ctx;
    EGLConfig  cfg;
    ...
    fprintf (fp, " %-32s: ", "EGL_CONFIG_CAVEAT"); ival = -1;
    ...
    fprintf (fp, " %-32s: ", "EGL_CONFORMANT"); ival = -1;
    ...
    fprintf (fp, " %-32s: ", "EGL_RENDERABLE_TYPE"); ival = -1;
    ...
    fprintf (fp, " %-32s: ", "EGL_SAMPLE_BUFFERS"); ival = -1;
    eglGetConfigAttrib (dpy, cfg, EGL_SAMPLE_BUFFERS, &ival);
    fprintf (fp, "%d\n", ival);

    fprintf (fp, " %-32s: ", "EGL_SAMPLES"); ival = -1;
    eglGetConfigAttrib (dpy, cfg, EGL_SAMPLES, &ival);
    fprintf (fp, "%d\n", ival);

    fprintf (fp, " %-32s: ", "EGL_STENCIL_SIZE"); ival = -1;
    eglGetConfigAttrib (dpy, cfg, EGL_STENCIL_SIZE, &ival);
    fprintf (fp, "%d\n", ival);

    fprintf (fp, " %-32s: ", "EGL_SURFACE_TYPE"); ival = -1;
    ...
    fprintf (fp, " %-32s: ", "EGL_TRANSPARENT_TYPE"); ival = -1;
    ...
    fprintf (fp, " %-32s: ", "EGL_TRANSPARENT_RED_VALUE"); ival = -1;
    eglGetConfigAttrib (dpy, cfg, EGL_TRANSPARENT_RED_VALUE, &ival);
    fprintf (fp, "%d\n", ival);

    fprintf (fp, " %-32s: ", "EGL_TRANSPARENT_GREEN_VALUE"); ival = -1;
    eglGetConfigAttrib (dpy, cfg, EGL_TRANSPARENT_GREEN_VALUE, &ival);
    fprintf (fp, "%d\n", ival);

    fprintf (fp, " %-32s: ", "EGL_TRANSPARENT_BLUE_VALUE"); ival = -1;
...
int
egl_show_current_surface_attrib (FILE *fp)
{
    EGLDisplay dpy;
    EGLSurface sfc;
    EGLint ival;
    ...
    fprintf (fp, " %-32s: ", "EGL_SWAP_BEHAVIOR"); ival = -1;
    ...
    fprintf (fp, " %-32s: ", "EGL_HORIZONTAL_RESOLUTION"); ival = -1;
    eglQuerySurface(dpy, sfc, EGL_HORIZONTAL_RESOLUTION, &ival);
    fprintf (fp, "%d\n", ival);

    fprintf (fp, " %-32s: ", "EGL_VERTICAL_RESOLUTION"); ival = -1;
    eglQuerySurface(dpy, sfc, EGL_VERTICAL_RESOLUTION, &ival);
    fprintf (fp, "%d\n", ival);

    fprintf (fp, " %-32s: ", "EGL_PIXEL_ASPECT_RATIO"); ival = -1;
