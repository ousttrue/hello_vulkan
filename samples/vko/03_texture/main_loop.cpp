...
vko::Pipeline
createPipelineObject(VkDevice device,
                     //
  ...
  return builder.create(
      ...
      vertexInputBindingDescriptions, attributeDescriptions);
}
...
void main_loop(const std::function<bool()> &runLoop,
  ...
  auto pipeline = createPipelineObject(device,
                                       ...
                                       scene.vertexInputBindingDescriptions,
